...
if (FAT_RUNTIME)
    ...
    if (NOT (ARCH_IA32 OR ARCH_X86_64 OR ARCH_AARCH64 OR ARCH_RISCV64))
        message(FATAL_ERROR "Fat runtime is only supported on Intel, Aarch64 and RISC-V architectures")
    else()
